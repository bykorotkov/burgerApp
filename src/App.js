      ...
      <div className="form-app">
        ...
        {!hasOrdered && <form className='form-app__form'>
          ...
          <div className='selection'>
              ...
              <button className='affirmation' type='submit' onClick={handleSubmitButton}>Оформить заказ</button>
              <button className='affirmation' type='submit' onClick={handleSubmitButton}>Сбросить</button>
